CREATE TABLE declares_availabilities(
    ...
    PRIMARY KEY(caretaker_username, start_timestamp) --Two availabilities belonging to the same caretaker should not have the same start date. They will be merged
);
